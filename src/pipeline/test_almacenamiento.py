#Este código hace las pruebas unitarias del almacenamiento, toma como entrada lo almacenado y como salida genera metadata de la prueba unitaria, que es el tamaño del objeto
import luigi
import boto3
from io import BytesIO
from luigi.contrib.postgres import CopyToTable
from src.utils.general import *
from src.utils.test_almacenar import *
...
class test_almacenar(CopyToTable):
    ...
    def requires(self):
        return almacenar(self.tipo_ingesta, self.fecha, self.bucket, self.tamanio)
